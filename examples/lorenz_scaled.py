"""
Example: Scaled Lorenz System
Demonstrates the resolvent learning framework for a 3D polynomial system.
"""
...
DIM = len(f_symbolic)
SYMBOLS = [x, y, z][:DIM]  # Extract only the symbols needed
...
MONOMIAL_DEGREES = [2, 2, 2]  # Polynomial degrees for each dimension
